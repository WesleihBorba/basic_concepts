...
class LogisticRegressionAnalysis(CreateErrorInDatabase):
    ...
    def analysis_data(self):
        ...
        # Creating an error in data, changing a number of class (Create Error)
        self.y_data = self.transform_y_class(self.y_data)

        # Add Null values in X data (Create Error)
        self.x_data = self.add_nan_in_x(self.x_data)

        # Reshape data X (Create Error)
        self.x_data = self.reshape_data_x(self.x_data)

        # Resize and bring a error in X (Create Error)
        ...
        classification_report_data = classification_report(y_test, y_prediction)
        print(f'accuracy score: {accuracy}')
        print(f'Classification report : \n  {classification_report_data}')


class_logistic = LogisticRegressionAnalysis(X, y)
class_logistic.analysis_data()
